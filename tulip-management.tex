...
%
\title{Research Materials Management}
\author{
Meng Ren
\\
...
cf={Research Materials Management},
}
...
\onslide*{5,5-}{
\begin{itemize}
  \item There contains the content that has been fully researched and published in TULIP.
%  \item \textcolor{orange}{\textit{Code}}
    \begin{itemize}
      \item \textit{TULIP Open-code}: \url{https://github.com/tulip-lab/open-code}
    \end{itemize}
%  \item \textcolor{orange}{\textit{Data in TULIP}}
  \begin{itemize}
    \item \textit{TULIP Open-data}: \url{https://github.com/tulip-lab/open-data}
  \end{itemize}
\end{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item \textcolor{orange}{\textit{Blog}}: \url{https://mren.tulip.academy}
...
\begin{itemize}
    \item \textcolor{orange}{\textit{Blog}}
       \begin{itemize}
         \item When we have a new understanding of a small research topic,
         try to record it and give it. Because of that the more you summarize the more you gain.
       \end{itemize}
  \end{itemize}
}}
{
...
\begin{itemize}
    \item \textcolor{orange}{\textit{Idea Bank}}
      \begin{itemize}
        \item At any chance when read papers,
        there can be a new idea, but it can't be completed immediately,
        you need to collect the idea.
        When there is no research problem to do, you can go to the content collected before.
      \end{itemize}
  \end{itemize}
}
}}
