...
\smartdiagram[descriptive diagram]{
  {Second,Paper Summary and Analysis}}
\smartdiagram[descriptive diagram]{
...
\begin{figure}
  ...
  \includegraphics[width=3in]{figures/computer.eps}\\
%  \caption{Mendeley_Logo}
\end{figure}

\onslide*{2,2-}{
\begin{center}
\texttt{System Breakdown, Computer Damage, Lose the Document and etc.}
\end{center}
}

\onslide*{3,3-}{
\begin{itemize}
  \item \textcolor{orange}{\textit{Baidu Drive}}:  is a Cloud service provided by Baidu. It offers a cloud storage service, client software, file management, resources sharing, and Third Party Integration.
  \item \textcolor{orange}{\textit{Bitbucket}}: Collaborative version control(Article writing collaboration tool in TULIP).
  \item \textcolor{orange}{\textit{Github}}: is a web-based hosting service for version control using Git
\end{itemize}}
